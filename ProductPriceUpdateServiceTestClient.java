...
public class ProductPriceUpdateServiceTestClient {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (productModel != null) {
            ...
            System.out.println("  Current Price: " + productModel.price);
            System.out.print("Enter New Price: ");
            productModel.price = Double.parseDouble(scanner.nextLine().trim());
            ...
            System.out.println("\nNew price for " + updatedModel.name + " entered into database as $" + updatedModel.price + ".");
